...
[inference-image-debugging](https://github.com/kyopark2014/iot-greengrass/blob/main/greengrass-commands.md#inference-image-debugging)에서는 Lambda등 인프라 배포전에 Container Image가 정상적인지 확인하는 방법에 대해 설명합니다. 
